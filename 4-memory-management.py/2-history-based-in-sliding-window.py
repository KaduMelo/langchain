...
prompt = ChatPromptTemplate.from_messages([
    ("system", "You're a helpful assistant that answers with a shot joke when possible."),
...
response1 = conversational_chain.invoke({"input": "My name is Carlos Eduardo. Reply only with 'OK and do not mention my name"}, config=config)
print("Assistant:", response1.content)
print("-"*30)

response2 = conversational_chain.invoke({"input": "Tell me a one-sentence fun fact. Do not mention me name"}, config=config)
